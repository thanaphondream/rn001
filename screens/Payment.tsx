...
const Payment = ({ route }) => {
    ...
    const { user, booking, amount } = route.params;
    ...
    const postPayment = async () => {
        try {
            ...
            const rs = await axios.post(
                'https://f744-202-29-24-199.ngrok-free.app/api/payments/',
                formData, {
                headers: {
            ...
            console.log('dfff', data1, booking);

            const rs1 = await axios.put(`https://f744-202-29-24-199.ngrok-free.app/api/bookingput/${booking}/`, data1, {
                headers: {
                    Authorization: 'Token 3110b82b454bcd20ba4740bf00ef832aad02f9b9',
                },
            });
